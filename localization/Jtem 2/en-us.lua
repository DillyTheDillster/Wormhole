				...
				text = {
					{
						...
						"{C:inactive}(Currently {V:1}#1#{C:inactive}, must be in order)",
					},
					{
						"{X:mult,C:white,s:0.9}Use{} this {C:attention}Joker{} during a {C:red}Solar{} Eclipse:",
						"{C:red}Discards{} {C:attention}odd{}: turns {C:attention}all cards in hand{} to {C:hearts}Hearts",
						"{C:red}Discards{} {C:attention}even{}: turns {C:attention}all cards in hand{} to {C:diamonds}Diamonds",
					},
					{
						"{X:mult,C:white,s:0.9}Use{} this {C:attention}Joker{} during a {C:blue}Lunar{} Eclipse:",
						"{C:blue}Hands{} {C:attention}odd{}: turns {C:attention}all cards in hand{} to {C:clubs}Clubs",
						"{C:blue}Hands{} {C:attention}even{}: turns {C:attention}all cards in hand{} to {C:spades}Spades",
					},
				},
			},
